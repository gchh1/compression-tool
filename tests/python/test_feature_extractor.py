...
def test_empty_data():
    ...
    from gui.ade.features import FeatureExtractor, BaseFeatures
...
def test_repetitive_data():
    ...
    from gui.ade.features import extract_base_features, get_compression_decision
...
def test_magic_bytes_detection():
    ...
    from gui.ade.features import extract_base_features, FileType
...
def test_serialization():
    ...
    from gui.ade.features import extract_base_features
    import json
...
def test_performance():
    ...
    import time
    from gui.ade.features import FeatureExtractor
