...
from gui.ui.main_window import FileTableWidget, DecisionDetailDialog
from gui.models import FileRecord, CompressionStatus, AlgorithmType
...
def test_add_file_with_algorithm():
    ...
    assert algo_item.text() == "lzdp", f"Expected 'lzdp', got '{algo_item.text()}'"
...
def test_decision_result_persistence():
    ...
    from gui.ade.engine import DecisionEngine, DecisionResult
...
def test_decision_detail_dialog():
    ...
    from gui.ade.engine import DecisionResult
