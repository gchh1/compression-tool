...
int main() {
    ...
    std::cout << "Original size: " << compress_result.original_size
              << std::endl;
    std::cout << "Compressed size: " << compress_result.compressed_size
              << std::endl;
    std::cout << "Compression ratio: " << compress_result.compression_ratio
              << std::endl;
    std::cout << "Time: " << compress_result.time_ms << " ms" << std::endl;

    // 解压
    auto decompress_result = compressor.decompress(compress_result.data);
    std::cout << "Decompressed size: " << decompress_result.compressed_size
              << std::endl;
