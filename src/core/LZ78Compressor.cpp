...
/**
 * @brief Using LZ78 and Huffman to compress data
 *
 * @param original_data
 * @return CompressorResult
 */
auto LZ78Compressor::compress(std::vector<uint8_t> original_data)
    -> CompressorResult {
    // Preparation
    ...
    std::vector<algorithm::Token> tokens =
        algorithm::LZ78::compress(original_data);
 ...
 * @return CompressorResult
 */
auto LZ78Compressor::decompress(std::vector<uint8_t> compressed_data)
    -> CompressorResult {
    // Preparation
    CompressorResult result;
    ...
    /* 3. LZ78 decompress */
    result.data = algorithm::LZ78::decompress(tokens);
...
// ---------------------------------------------------------
/**
 * @brief Serialize the Token stream generated by LZ78 to byte stream for
 *        Huffman to compress
 *
 * @param tokens
 * @return std::vector<uint8_t>
 */
auto LZ78Compressor::serializeTokens(std::vector<algorithm::Token> tokens)
    -> std::vector<uint8_t> {
    // Preparation
 ...
 */
auto LZ78Compressor::deserializeTokens(std::vector<uint8_t> data)
