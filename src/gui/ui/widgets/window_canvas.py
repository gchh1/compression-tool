...
Driven by MatchEvent data from .viz files ΓÇö shows the search buffer,
...
class WindowCanvas(QWidget):
    ...
    # ΓöÇΓöÇ internal helpers ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ events ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ painting ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    def paintEvent(self, event) -> None:
        ...
        if not self._match_events:
            ...
            painter.drawText(
                ...
                "µùáσî╣Θàìµò░µì« ΓÇö Φ»╖σàêσÄïτ╝⌐µûçΣ╗╢Σ╗ÑτöƒµêÉ .viz"
    ...
    def _draw_header(
        ...
        if curr_ev:
            ...
            painter.drawText(8, header_h - 6, "µ╗æσè¿τ¬ùσÅú ΓÇö Σ╜┐τö¿µ╗ÜΦ╜«/µ╗æσ¥ùµ╡ÅΦºê")
        ...
        if total > 0:
            ...
            step_text = (
                ...
                f"µ¡ÑΘ¬ñ {self._current_idx + 1}/{total}"
