...
# ΓöÇΓöÇ RFC 1951 length / distance tables ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ



# Length code ΓåÆ (base_length, extra_bits)
...
# Distance code ΓåÆ (base_distance, extra_bits)
...
# ΓöÇΓöÇ Canonical Huffman code builder ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
# ΓöÇΓöÇ CharEncodingRatioBuilder ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
class CharEncodingRatioBuilder:
    ...
    def __init__(self, viz_loader: VizLoader | None) -> None:
        ...
        # Per-block cache: block_index ΓåÆ (start_offset, end_offset, [ratios])
    ...
    # ΓöÇΓöÇ data loading ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    def _load_data(self) -> None:
        ...
        # DO NOT load all MatchEvents ΓÇö for large files (1GB+) there can be
    ...
    # ΓöÇΓöÇ block-level compression ratio ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ lazy MatchEvent loading ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    def _ensure_matches(self, range_start: int, range_end: int) -> None:
        ...
        Uses binary search via O(1) mmap reads ΓÇö only the events actually
        ...
        # ΓöÇΓöÇ Binary search for first event with input_pos >= range_start ΓöÇΓöÇ
    ...
    # ΓöÇΓöÇ per-character ratio computation ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    def _estimate_ratio_heuristic(self, match_event: MatchEvent) -> float:
        ...
        - Literal ΓåÆ 1.0 (uncompressed)

        - Short distance match ΓåÆ 0.2 (good compression)

        - Far distance match ΓåÆ 0.5 (more expensive distance code)

        """

        if match_event.offset == 0:

            return 1.0  # literal ΓÇö no compression
    ...
    def compute_ratio(self, byte_offset: int) -> float:
        ...
        if match_idx < 0:
            ...
            return 1.0  # no data ΓåÆ assume uncompressed
        ...
        if m.offset == 0 and m.length == 0:
            ...
            return 1.0  # approximate ΓÇö could use the literal code lengths
