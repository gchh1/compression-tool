...
from gui.widgets.block_visualizer import BlockProfilerPanel
from gui.widgets.huffman_visualizer import HuffmanTreePanel
from gui.core.models import FileRecord, FolderRecord
