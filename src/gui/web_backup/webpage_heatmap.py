...
(function() {
  const _t = {
    bg: '{t.bg_elevated}', border: '{t.border}', text: '{t.text_primary}',
    text2: '{t.text_secondary}', surface: '{t.bg_surface}', accent: '{t.accent}',
    muted: '{t.text_muted}'
  };
  ...
  panel.id = 'wcx-panel';
  panel.innerHTML = `
    <div style="position:fixed;bottom:16px;right:16px;background:_t.bg;border:1px solid _t.border;
                border-radius:12px;padding:16px 20px;font-family:'Microsoft YaHei',sans-serif;
                color:_t.text;font-size:13px;z-index:99999;box-shadow:0 8px 32px rgba(0,0,0,0.5);
                min-width:280px;max-width:400px;">
      <div style="font-size:16px;font-weight:700;margin-bottom:8px;">🔥 网页资源压缩热力图</div>
      <div style="color:_t.text2;font-size:11px;margin-bottom:12px;">标注资源: __COUNT__ 个</div>
      <div style="display:flex;gap:8px;margin-bottom:8px;">
        <div style="background:_t.surface;border-radius:6px;padding:8px 12px;flex:1;text-align:center;">
          <div style="font-size:18px;font-weight:700;color:_t.accent;">__TOTAL_ORIG__</div>
          <div style="font-size:10px;color:_t.text2;">原始大小</div>
        </div>
        <div style="background:_t.surface;border-radius:6px;padding:8px 12px;flex:1;text-align:center;">
          <div style="font-size:18px;font-weight:700;color:_t.accent;">__TOTAL_COMP__</div>
          <div style="font-size:10px;color:_t.text2;">压缩后</div>
        </div>
        <div style="background:_t.surface;border-radius:6px;padding:8px 12px;flex:1;text-align:center;">
          <div style="font-size:18px;font-weight:700;color:_t.accent;">__TOTAL_RATIO__</div>
          <div style="font-size:10px;color:_t.text2;">总压缩率</div>
        </div>
      </div>
      <div style="display:flex;gap:8px;">
        <div style="background:_t.surface;border-radius:6px;padding:6px 10px;flex:1;text-align:center;">
      ...
      <div style="margin-top:8px;color:_t.muted;font-size:10px;">图例: 🟢高效 🟡中等 🔴低效 | 资源边框颜色=压缩热力</div>
    </div>
  `;
