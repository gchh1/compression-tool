...
- Backup created at [`main_window.py.backup`](../src/gui/widgets/main_window.py.backup)
...
- **Main Window**: [`src/gui/widgets/main_window.py`](../src/gui/widgets/main_window.py)
- **Backup File**: [`src/gui/widgets/main_window.py.backup`](../src/gui/widgets/main_window.py.backup)
