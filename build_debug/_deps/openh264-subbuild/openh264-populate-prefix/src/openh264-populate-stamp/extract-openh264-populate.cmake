...
#
get_filename_component(filename "D:/AAA_C/compression-tool/build_debug/_deps/openh264-subbuild/openh264-populate-prefix/src/v2.4.1.tar.gz" ABSOLUTE)
get_filename_component(directory "D:/AAA_C/compression-tool/build_debug/_deps/openh264-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-openh264-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-openh264-populate${i}")
